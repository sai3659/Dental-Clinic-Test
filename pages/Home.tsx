...
import { ArrowRight, CheckCircle2, Shield, Calendar, Phone, Star, ChevronLeft, ChevronRight, Quote } from 'lucide-react';
    ...
    <div className="w-full">
      ...
      <section className="relative min-h-[90vh] flex items-center overflow-hidden bg-slate-50 dark:bg-slate-900">
        ...
        <div className="absolute inset-0 md:hidden z-0">
          ...
          />
          <div className="absolute inset-0 bg-gradient-to-b from-slate-50/90 via-slate-50/80 to-slate-50 dark:from-slate-900/90 dark:via-slate-900/80 dark:to-slate-900"></div>
        </div>

        {/* Abstract Background Shapes (PC View) */}
        <div className="absolute inset-0 w-full h-full overflow-hidden hidden md:block">
           <div className="absolute top-0 right-0 w-[800px] h-[800px] bg-sky-200 dark:bg-indigo-900/30 rounded-full mix-blend-multiply filter blur-3xl opacity-70 animate-blob"></div>
           <div className="absolute top-0 left-0 w-[600px] h-[600px] bg-teal-200 dark:bg-purple-900/30 rounded-full mix-blend-multiply filter blur-3xl opacity-70 animate-blob animation-delay-2000"></div>
           <div className="absolute -bottom-32 left-20 w-[600px] h-[600px] bg-pink-200 dark:bg-pink-900/30 rounded-full mix-blend-multiply filter blur-3xl opacity-70 animate-blob animation-delay-4000"></div>
        </div>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="space-y-8 text-center md:text-left">
               ...
               <div className="flex flex-col sm:flex-row gap-4 pt-4 justify-center md:justify-start">
                  <Link to="/booking" className="bg-gradient-to-r from-secondary to-primary dark:from-indigo-600 dark:to-purple-600 text-white px-8 py-4 rounded-full font-bold shadow-lg shadow-sky-200 dark:shadow-indigo-900/50 hover:shadow-xl hover:-translate-y-1 transition-all text-center flex items-center justify-center gap-2">
                    <Calendar size={20} /> Book Appointment
                  </Link>
                  <Link to="/contact" className="bg-white dark:bg-slate-800 text-secondary dark:text-sky-300 border border-secondary dark:border-slate-600 px-8 py-4 rounded-full font-bold hover:bg-sky-50 dark:hover:bg-slate-700 transition-colors text-center flex items-center justify-center gap-2">
               ...
               <div className="flex items-center gap-8 pt-4 justify-center md:justify-start">
                  <div className="flex -space-x-4">
                     ...
                     <div className="w-10 h-10 rounded-full border-2 border-white dark:border-slate-900 bg-secondary dark:bg-purple-600 text-white flex items-center justify-center text-xs font-bold z-10">
            ...
            <div className="relative hidden lg:block">
               {/* Main Card */}
               <div className="relative z-20 bg-white/30 dark:bg-slate-800/30 backdrop-blur-xl border border-white/50 dark:border-white/10 p-4 rounded-[2.5rem] shadow-2xl transform rotate-2 hover:rotate-0 transition-all duration-500">
                  <div className="rounded-[2rem] overflow-hidden">
                     <img src="https://images.unsplash.com/photo-1629909613654-28e377c37b09?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80" alt="Modern Dental Clinic" className="w-full h-[500px] object-cover" />
                  </div>
                  
                  {/* Floating Elements */}
                  <div className="absolute -left-12 top-1/4 bg-white dark:bg-slate-800 p-4 rounded-2xl shadow-xl flex items-center gap-3 animate-bounce-slow">
                  ...
                  <div className="absolute -right-8 bottom-1/4 bg-white dark:bg-slate-800 p-4 rounded-2xl shadow-xl flex items-center gap-3 animate-bounce-slow" style={{animationDelay: '1s'}}>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-2 md:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-8">
            {SERVICES.map((service) => (
              <div key={service.id} className="bg-slate-50 dark:bg-slate-900 p-6 md:p-8 rounded-2xl hover:bg-white dark:hover:bg-slate-800 hover:shadow-xl dark:hover:shadow-black/50 transition-all duration-300 border border-transparent hover:border-sky-100 dark:hover:border-slate-700 group flex flex-col h-full">
                <div className="w-10 h-10 md:w-14 md:h-14 bg-white dark:bg-slate-800 rounded-xl shadow-sm flex items-center justify-center text-secondary dark:text-sky-400 mb-4 md:mb-6 group-hover:bg-secondary dark:group-hover:bg-purple-600 group-hover:text-white transition-colors border border-slate-100 dark:border-slate-700">
                ...
                <Link to="/services" className="inline-flex items-center text-secondary dark:text-sky-400 font-semibold text-xs md:text-sm hover:gap-2 transition-all mt-auto">
          ...
          <div className="text-center mt-12">
            <Link to="/services" className="bg-slate-100 dark:bg-slate-800 text-slate-700 dark:text-slate-300 hover:bg-secondary dark:hover:bg-purple-600 hover:text-white px-8 py-3 rounded-full font-medium transition-colors">
              View All Treatments
            </Link>
          </div>
        </div>
          ...
          <div className="grid md:grid-cols-2 gap-16 items-center">
             <div>
               ...
               <div className="space-y-6">
                 <div className="flex gap-4">
                   <div className="bg-secondary/20 dark:bg-purple-600/20 p-3 rounded-lg h-fit text-secondary dark:text-purple-400"><Shield size={24} /></div>
                   <div>
                     <h4 className="text-xl font-semibold mb-2">Advanced Sterilization</h4>
                     <p className="text-slate-400 text-sm">We follow strict 7-step sterilization protocols to ensure 100% patient safety.</p>
                   </div>
                 </div>
                 <div className="flex gap-4">
                   <div className="bg-secondary/20 dark:bg-purple-600/20 p-3 rounded-lg h-fit text-secondary dark:text-purple-400"><CheckCircle2 size={24} /></div>
                   <div>
                 ...
                 <div className="flex gap-4">
                   <div className="bg-secondary/20 dark:bg-purple-600/20 p-3 rounded-lg h-fit text-secondary dark:text-purple-400"><Calendar size={24} /></div>
                   <div>
                     <h4 className="text-xl font-semibold mb-2">Automated Care</h4>
             ...
             <div className="bg-white/5 p-8 rounded-3xl border border-white/10 backdrop-blur-sm">
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div className="bg-slate-800 dark:bg-slate-900 p-4 rounded-xl text-center">
      ...
      <section className="py-20 bg-sky-50 dark:bg-slate-900">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-8 text-center">
             <Link to="/doctors" className="inline-flex items-center gap-2 text-secondary dark:text-sky-400 font-bold hover:gap-3 transition-all border border-secondary dark:border-sky-400 px-8 py-3 rounded-full hover:bg-secondary hover:text-white dark:hover:bg-sky-400 dark:hover:text-slate-900">
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="relative">
             <div className="overflow-hidden">
                <div className="bg-slate-50 dark:bg-slate-900 rounded-3xl p-8 md:p-12 shadow-xl border border-slate-100 dark:border-slate-800 relative transition-colors">
             ...
             <div className="flex justify-center items-center gap-4 mt-8">
               <button onClick={prevTestimonial} className="p-3 rounded-full bg-white dark:bg-slate-800 shadow-md hover:bg-slate-50 dark:hover:bg-slate-700 text-slate-600 dark:text-slate-300 transition-colors">
                 <ChevronLeft size={24} />
               </button>
               <div className="flex gap-2">
                 {TESTIMONIALS.map((_, idx) => (
                   <button 
                     ...
                     className={`w-3 h-3 rounded-full transition-all ${currentTestimonial === idx ? 'bg-secondary dark:bg-purple-600 w-8' : 'bg-slate-300 dark:bg-slate-700'}`}
                   />
                 ))}
               </div>
               <button onClick={nextTestimonial} className="p-3 rounded-full bg-white dark:bg-slate-800 shadow-md hover:bg-slate-50 dark:hover:bg-slate-700 text-slate-600 dark:text-slate-300 transition-colors">
      ...
      <section className="py-20 bg-white dark:bg-slate-950">
        <div className="max-w-5xl mx-auto px-4">
          <div className="bg-gradient-to-r from-secondary to-teal-800 dark:from-indigo-600 dark:to-purple-800 rounded-3xl p-10 md:p-16 text-center text-white shadow-2xl relative overflow-hidden">
            ...
            <Link to="/booking" className="inline-block bg-white text-teal-800 dark:text-purple-800 px-10 py-4 rounded-full font-bold shadow-lg hover:shadow-xl hover:scale-105 transition-all relative z-10">
